 ...
 */
final class Version20221005075234 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE status (id INT AUTO_INCREMENT NOT NULL, permission_id INT DEFAULT NULL, active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_7B00651CFED90CCA (permission_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE status ADD CONSTRAINT FK_7B00651CFED90CCA FOREIGN KEY (permission_id) REFERENCES permission (permID)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE status DROP FOREIGN KEY FK_7B00651CFED90CCA');
